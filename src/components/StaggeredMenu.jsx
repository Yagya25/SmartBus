  ...
  return (
    ...
    >
      <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true">
        {(() => {
          const raw = colors?.length ? colors.slice(0, 4) : ['#1a1a2e', '#0f1419'];
          let arr = [...raw];
        ...
        <div className="sm-logo" aria-label="Logo">
          <div className="sm-logo-icon">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M8 6v6m0 0v6m0-6h8M6 4h12a2 2 0 012 2v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2z" />
            </svg>
          </div>
          <span className="sm-logo-text">SmartBus</span>
        </div>
        <button
          ref={toggleBtnRef}
          className="sm-toggle"
